...
from model_MLPUnet_branch import MLPMixerUnet
import logging
...
if __name__ == "__main__":
    ...
    # Initializing model
    mlpmixerunet = MLPMixerUnet(args.patch_size, S, args.c, args.num_of_mlp_blocks, args.image_size, args.batch_size)
    ...
    hdf5_file = "{0}/mlpunettrain.hdf5".format(args.model_weight)
