...
if __name__ == "__main__":
    ...
    parser.add_argument("--test-file-path", default='{}/data/test'.format(home_dir), type=str, required=False)
    ...
    images = []
    for img in os.listdir(args.test_file_path):
        img = tf.keras.preprocessing.image.load_img(args.test_file_path+"/"+img)
